function [db_data,x,z]=spreading_noplot(c,freq,radius);
% subroutine called by prop_nov_time and prop_nov_time_stacked
...
% exactly like spreading.m in all ways except does not plot results
